...
final Map<String, List<ExerciseData>> expertExercises = {
  ...
  ExerciseData(
    ...
    videoUrl:
        'https://youtube.com/shorts/hWbUlkb5Ms4?si=GO4RcUhoU89V0n0t',
  ),
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/chest.png',
    videoUrl:
        'https://youtube.com/shorts/98HWfiRonkE?si=t8MInuIiBk8vMU2-',
  ),
  ExerciseData(
    name: 'Weighted Dips',
    sets: 4,
    ...
    iconPath: 'assets/icons/exercises/chest.png',
    videoUrl:
        'https://youtube.com/shorts/TZxOiJHUpyA?si=eYdfZsl2GxSlMD7E',
  ),
  ExerciseData(
    name: 'Cable Fly',
    sets: 4,
    ...
    iconPath: 'assets/icons/exercises/chest.png',
    videoUrl:
        'https://youtube.com/shorts/y4RJDSOBEl8?si=12JUobkYkRTeppIj',
  ),
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/chest.png',
    videoUrl:
        'https://youtube.com/shorts/8fXfwG4ftaQ?si=sbXenqt8i9W0G0Xd',
  ),
],
...
'Sunday': [
  ExerciseData(
    ...
    videoUrl:
        'https://youtube.com/shorts/eDP_OOhMTZ4?si=3jy4kFAy6uxiqXw_',
  ),
  ExerciseData(
    name: 'Deadlift',
    sets: 5,
    ...
    iconPath: 'assets/icons/exercises/back.png',
    videoUrl:
        'https://youtube.com/shorts/ZaTM37cfiDs?si=F6FRyR4lB9tkEQ3O',
  ),
  ExerciseData(
    name: 'Bent Over Row',
    sets: 5,
    ...
    iconPath: 'assets/icons/exercises/back.png',
    videoUrl:
        'https://youtu.be/6FZHJGzMFEc?si=7ptwjJDoKp8Z7pss',
  ),
  ExerciseData(
    name: 'T-Bar Row',
    sets: 4,
    ...
    iconPath: 'assets/icons/exercises/back.png',
    videoUrl:
        'https://youtube.com/shorts/Nm3M-4fmprk?si=BCQ3at23D3WtTHGm',
  ),
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/back.png',
    videoUrl:
        'https://youtube.com/shorts/hAMcfubonDc?si=5BFDJz_XQ3H53ibg',
  ),
],
  'Monday': [
  ExerciseData(
    ...
    videoUrl:
        'https://youtube.com/shorts/4LBVP2Oe7fg?si=vmnUORIK_2pB674c',
  ),
  ExerciseData(
    name: 'Arnold Press',
    sets: 4,
    ...
    iconPath: 'assets/icons/exercises/sholders.png',
    videoUrl:
        'https://youtube.com/shorts/6K_N9AGhItQ?si=owODkQBewUlqhoPh',
  ),
  ExerciseData(
    name: 'Lateral Raise',
    sets: 5,
  ...
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/sholders.png',
    videoUrl:
        'https://youtube.com/shorts/IeOqdw9WI90?si=_y-CvccaHd101csG',
  ),
  ExerciseData(
    name: 'Barbell Shrugs',
    sets: 5,
    ...
    iconPath: 'assets/icons/exercises/sholders.png',
    videoUrl:
        'https://youtube.com/shorts/rFsSeClGnNA?si=C9roYRsZZtwe5s8v',
  ),
],
...
'Tuesday': [
  ExerciseData(
    ...
    videoUrl:
        'https://youtube.com/shorts/yXCFBwZ4LLU?si=FEuPtc4TLAvKEJpw',
  ),
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/bi&tri.png',
    videoUrl:
        'https://youtube.com/shorts/fXFN8_1Bh6k?si=zQFYSRoUs037QvCR',
  ),
  ExerciseData(
    name: 'Hammer Curl',
    sets: 4,
  ...
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/bi&tri.png',
    videoUrl:
        'https://youtube.com/shorts/VXJCfMES2C8?si=HhIoMJsBLwZSIpec',
  ),
  ExerciseData(
    name: 'Skull Crushers',
    sets: 4,
    ...
    iconPath: 'assets/icons/exercises/bi&tri.png',
    videoUrl:
        'https://youtube.com/shorts/dtkD5sQLFL4?si=2cYi02acA_kxRsgc',
  ),
],
  ...
  ExerciseData(
    ...
    videoUrl:
        'https://youtube.com/shorts/PPmvh7gBTi0?si=xPIRAM6-qTjbIUou',
  ),
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/leg.png',
    videoUrl:
        'https://youtube.com/shorts/5rIqP63yWFg?si=BfgZXWMiaefH6BwR',
  ),
  ExerciseData(
    name: 'Walking Lunges',
    sets: 4,
    ...
    iconPath: 'assets/icons/exercises/leg.png',
    videoUrl:
        'https://youtube.com/shorts/HIM0GrawvAU?si=O5HtPBRonRHB-D0-',
  ),
  ExerciseData(
    name: 'Leg Extension',
    sets: 4,
    ...
    iconPath: 'assets/icons/exercises/leg.png',
    videoUrl:
        'https://youtu.be/YyvSfVjQeL0?si=EXmH3W1GrV0qTmTa',
  ),
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/leg.png',
    videoUrl:
        'https://youtube.com/shorts/wdOkFomQNp8?si=yit0YQGkStUR4rTk',
  ),
],
...
'Thursday': [
  ExerciseData(
    ...
    videoUrl:
        'https://youtube.com/shorts/bEY-ister9w?si=w63r9xKaU0Fm5sQq',
  ),
  ExerciseData(
    name: 'Battle Ropes',
    sets: 5,
    ...
    iconPath: 'assets/icons/exercises/cardio.png',
    videoUrl:
        'https://youtube.com/shorts/k3d8XozZyQQ?si=CDxQcsBSTymwSdEr',
  ),
  ExerciseData(
    name: 'Burpees',
    sets: 5,
    ...
    iconPath: 'assets/icons/exercises/cardio.png',
    videoUrl:
        'https://youtube.com/shorts/zDqi7OjlQdc?si=xcfKpT3dNrl7aezg',
  ),
  ExerciseData(
    name: 'Box Jumps',
    sets: 5,
    ...
    iconPath: 'assets/icons/exercises/cardio.png',
    videoUrl:
        'https://youtube.com/shorts/HJZh-12p6vg?si=5NwFp6aI6539G4go',
  ),
  ExerciseData(
    name: 'Rowing Machine',
    sets: 1,
    ...
    iconPath: 'assets/icons/exercises/cardio.png',
    videoUrl:
        'https://youtube.com/shorts/bCxq4zMHpzs?si=XIlN3LVsIbMXiLYy',
  ),
],
};
