...
final Map<String, List<ExerciseData>> intermediateExercises = {
  ...
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/chest.png',
    videoUrl:
        'https://youtube.com/shorts/8fXfwG4ftaQ?si=5f9IeJ6U5A84RL0d',
  ),
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/chest.png',
    videoUrl:
        'https://youtube.com/shorts/y4RJDSOBEl8?si=92uDb95_dWPWw-2l',
  ),
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/chest.png',
    videoUrl:
        'https://youtube.com/shorts/z4oz6W1X10w?si=poXX9H6i-ED6DeWJ',
  ),
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/chest.png',
    videoUrl:
        'https://youtube.com/shorts/Qu7-ceCvq7w?si=ZZXfEHrA_ooojT36',
  ),
],
...
'Sunday': [
  ...
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/back.png',
    videoUrl:
        'https://youtube.com/shorts/phVtqawIgbk?si=lo3R3a5M7yYNa8T_',
  ),
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/back.png',
    videoUrl:
        'https://youtu.be/GZbfZ033f74?si=Xtljwmcf7DdlMp_m',
  ),
  ExerciseData(
...
'Tuesday': [
  ...
  ExerciseData(
    ...
    iconPath: 'assets/icons/exercises/bi&tri.png',
    videoUrl:
        'https://youtube.com/shorts/1FjkhpZsaxc?si=GidGwLJyQZrI3HwH',
  ),
  ExerciseData(
    name: 'Skull Crushers',
    sets: 4,
  ...
  ExerciseData(
    ...
    videoUrl:
        'https://youtube.com/shorts/dW3zj79xfrc?si=i2aGiM8eb7CKyg2I',
  ),
  ExerciseData(
