...
class _SettingsScreenState extends State<SettingsScreen> {
  Future<void> _confirmLogout() async {
    ...
    if (confirmed == true && mounted) {
      // Hook up real logout logic here (auth sign-out, clearing session,
      // navigating back to the login flow, etc.)
    }
  }
              ...
              children: [
                ...
                _SettingsCard(
                  child: SwitchListTile(
                    ...
                    secondary: const Icon(Icons.notifications_none_rounded, color: AppColors.textSecondary),
                  ),
                ),
